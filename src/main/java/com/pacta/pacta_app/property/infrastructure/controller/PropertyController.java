...
public class PropertyController {
    ...
    public void acceptRequest(
            ...
            @RequestHeader(PactaTokenFilter.HEADER_USER_ID) String landlordId) {
        PropertyRequest accepted = propertyService.acceptRequest(requestId, landlordId);
        Property property = propertyService.findById(accepted.getPropertyId());
        dealService.createFromAcceptedRequest(accepted, property);
    }
